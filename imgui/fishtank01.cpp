// sudo apt install libsdl2-dev libsdl2-image-dev libimgui-dev libstb-dev libgl-dev
// g++ -o fishtank fishtank01.cpp /usr/share/doc/libimgui-dev/examples/backends/imgui_impl_opengl3.cpp /usr/share/doc/libimgui-dev/examples/backends/imgui_impl_sdl2.cpp -I/usr/include/imgui -I/usr/include/imgui/backends -I/usr/include/SDL2 -lSDL2 -lGL -limgui -lstb -lm -lSDL2_image 
