// g++ -o test src/sdl2gui_06.cpp imgui/imgui.cpp imgui/imgui_draw.cpp imgui/imgui_demo.cpp imgui/backends/imgui_impl_opengl3.cpp imgui/backends/imgui_impl_sdl2.cpp imgui/imgui_tables.cpp imgui/imgui_widgets.cpp -Iimgui -Iimgui/backends -I/usr/include/SDL2 -lSDL2 -lGL && timeout 20s ./test
...
void initializeBalls() {
    for (int i = 0; i < NUM_BALLS; i++) {
        balls[i].x = (float)(rand() % (SCREEN_WIDTH - BALL_RADIUS * 2));
        balls[i].y = (float)(rand() % (SCREEN_HEIGHT - BALL_RADIUS * 2));
...
int main(int argc, char* argv[]) {
    ...
    while (!quit) {
        ...
        ImGui::Text("SDL2 + ImGui Integration Demo");
        ImGui::Separator();
        
        ImGui::SliderFloat("Test Slider", &sliderValue, 0.0f, 1.0f);
        ImGui::SliderFloat("Ball Speed Multiplier", &ballSpeed, 0.1f, 3.0f);
