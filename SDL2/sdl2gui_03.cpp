...
// cd ~/CodePlay && time g++ -o test src/sdl3gui_02.cpp imgui/imgui.cpp imgui/imgui_draw.cpp imgui/backends/imgui_impl_opengl3.cpp imgui/backends/imgui_impl_sdl2.cpp imgui/backends/imgui_impl_sdlrenderer2.cpp imgui/imgui_tables.cpp imgui/imgui_widgets.cpp -Iimgui -Iimgui/backends -I/usr/include/SDL2 -lSDL2 -lGL && timeout 20s ./test
// https://formatter.org/ Coding Style Google - Column Limit 160

// draw a circel using "SDL_RenderDrawPoint()" and integrate it here:
